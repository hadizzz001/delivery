...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 60725)), "C:\\Users\\abc\\Desktop\\Hadi\\My Bussiness\\Donishka\\web - delivery\\app\\reservation\\page.tsx"],
    ...
    const pages = ["C:\\Users\\abc\\Desktop\\Hadi\\My Bussiness\\Donishka\\web - delivery\\app\\reservation\\page.tsx"];
    ...
    const originalPathname = "/reservation/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 27418))
...
const page = ()=>{
    ...
    const a = async ()=>{
        const b = await (0,_utils__WEBPACK_IMPORTED_MODULE_4__/* .fetchTemp1 */ .sj)();
        setTemp(b);
    };
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        a();
    }, []);
    if (allTemp) console.log(allTemp);
    const calculateFinalTotal = (allTemp1)=>{
        if (allTemp1) {
            const result = allTemp1.reduce((acc, post)=>{
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tbody", {
                        children: allTemp && allTemp?.length > 0 ? allTemp.map((post, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("td", {
                                        children: [
                                            "$",
                                            (calculateFinalTotal(post.user).totalPrice + 3).toFixed(2)
                                        ]
                                    }),
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\abc\Desktop\Hadi\My Bussiness\Donishka\web - delivery\app\reservation\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,899,977,189,960], () => (__webpack_exec__(61996)));
